...
import org.fhnw.aigs.server.gui.StopServerAction;
...
import org.fhnw.aigs.server.gameHandling.GameLoader;
 ...
 * v1.2 Functional changes<br>
 * v1.3 Changes of logging
...
public class AIGSConsoleHandler {
    ...
    private void listAvailableGames()
    {
        ...
        //LOG//Logger.getLogger(AIGSConsoleHandler.class.getName()).log(Level.INFO, "List installed games...");
        LogRouter.log(AIGSConsoleHandler.class.getName(), LoggingLevel.system, "List installed games...");
    ...
    private void shutdownServer() {
        //LOG//Logger.getLogger(AIGSConsoleHandler.class.getName()).log(Level.INFO, "Shut down server...");
        LogRouter.log(AIGSConsoleHandler.class.getName(), LoggingLevel.system, "Shut down server...");
        System.exit(0);
    }
    ...
    private void showLogs() {
        //LOG//Logger.getLogger(AIGSConsoleHandler.class.getName()).log(Level.INFO, "Show logs folder...");
        LogRouter.log(AIGSConsoleHandler.class.getName(), LoggingLevel.system, "Show logs folder...");
    ...
    private void recompileClasses() {
        //LOG//Logger.getLogger(AIGSConsoleHandler.class.getName()).log(Level.INFO, "Recompile and reload classes...");
        LogRouter.log(AIGSConsoleHandler.class.getName(), LoggingLevel.system, "Recompile and reload classes...");
    ...
    private void listActiveGames() {
        //LOG//Logger.getLogger(AIGSConsoleHandler.class.getName()).log(Level.INFO, "List waiting and active games...");
        LogRouter.log(AIGSConsoleHandler.class.getName(), LoggingLevel.system, "List waiting and active games...");
    ...
    private void terminateAllGames() {
        //LOG//Logger.getLogger(AIGSConsoleHandler.class.getName()).log(Level.INFO, "Terminate all games...");
        LogRouter.log(AIGSConsoleHandler.class.getName(), LoggingLevel.system, "Terminate all games...");
        for(Game game : GameManager.waitingGames){
